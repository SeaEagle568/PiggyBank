...
func (x *RPCEvent) GetEventType() string {
	if x != nil {
		return x.EventType
	}
	return ""
...
func (x *RPCEvent) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *RPCEventResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RPCEventResult) ProtoMessage() {}

func (x *RPCEventResult) ProtoReflect() protoreflect.Message {
	mi := &file_proto_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RPCEventResult.ProtoReflect.Descriptor instead.
func (*RPCEventResult) Descriptor() ([]byte, []int) {
	return file_proto_event_proto_rawDescGZIP(), []int{1}
}

func (x *RPCEventResult) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *RPCEventResult) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_event_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x3c, 0x0a,
	0x08, 0x52, 0x50, 0x43, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x76, 0x65,
	...
	,
...
var file_proto_event_proto_goTypes = []interface{}{
	(*RPCEvent)(nil),       // 0: services.RPCEvent
	(*RPCEventResult)(nil), // 1: services.RPCEventResult
}
var file_proto_event_proto_depIdxs = []int32{
	0, // 0: services.Handler.Handle:input_type -> services.RPCEvent
	1, // 1: services.Handler.Handle:output_type -> services.RPCEventResult
