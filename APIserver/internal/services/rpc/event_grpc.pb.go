...
// HandlerClient is the client API for Handler auth.
//
...
// HandlerServer is the server API for Handler auth.
...
// UnsafeHandlerServer may be embedded to opt out of forward compatibility for this auth.
...
// Handler_ServiceDesc is the grpc.ServiceDesc for Handler auth.
