...
type HandlerClient interface {
	Handle(ctx context.Context, in *RPCEvent, opts ...grpc.CallOption) (*RPCEvent, error)
}
...
func (c *handlerClient) Handle(ctx context.Context, in *RPCEvent, opts ...grpc.CallOption) (*RPCEvent, error) {
	out := new(RPCEvent)
...
type HandlerServer interface {
	Handle(context.Context, *RPCEvent) (*RPCEvent, error)
...
func (UnimplementedHandlerServer) Handle(context.Context, *RPCEvent) (*RPCEvent, error) {
